...
public class AccommodationsUnitOfWork : GenericUnitOfWork<Accommodation>, IAccomodationsUnitOfWork
{
    private readonly IAccommodationsRepository _accomodationsRepository;

    public AccommodationsUnitOfWork(IGenericRepository<Accommodation> repository, IAccommodationsRepository accomodationsRepository) : base(repository)
    {
