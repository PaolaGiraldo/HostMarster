...
public partial class ExtraServicesIndex
{
    ...
    {
        var responseHppt = await Repository.GetAsync<List<ExtraService>>("api/extraServices");
        ...
        ExtraServices = responseHppt.Response!;
    }
    ...
    private async Task DeleteAsync(ExtraService extraService)
    {
        var result = await SweetAlertService.FireAsync(new SweetAlertOptions
        {
            ...
            Text = string.Format(Localizer["DeleteConfirm"], Localizer["ExtraService"], extraService.ServiceName),
        ...
        var responseHttp = await Repository.DeleteAsync($"api/extraServices/{extraService.Id}");
