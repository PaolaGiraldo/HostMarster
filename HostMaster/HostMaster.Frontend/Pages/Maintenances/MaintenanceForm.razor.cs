...
public partial class MaintenanceForm
{
    ...
    [EditorRequired, Parameter] public MaintenanceDTO MaintenanceDTO { get; set; } = null!;
    ...
    private void AccommodationChanged(Accommodation accommodation)
    {
        ...
        MaintenanceDTO.AccommodationId = accommodation.Id;
    }
